                            ...
                            <form:form modelAttribute="board" name="board" method="post" enctype="multipart/form-data">
                                ...
                                <div class="board_view2">
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <textarea id="nttCn" name="nttCn" class="f_txtar w_full h_300" title="내용"><c:out value="${result.nttCn}" escapeXml="true" /></textarea>
                                        ...
                                        <tr>
                                            <td class="lb">
                                                <span><spring:message code="cop.atchFileList" /></span>
                                            </td>
                                            <td>
                                ...
                                <div class="board_view_bot">
                                    ...
                                    <div class="right_col btn1">
                                        ...
                                        <a href="<c:url value='/cop/bbs${prefix}/selectBoardList.do'/>" class="btn btn_blue_46" onclick="fn_egov_select_noticeList();"><spring:message code="button.list" /></a>
                                    </div>
                                </div>
                                <!--// 버튼 영역 -->
                            </form:form>
