...
<head>
    ...
    <title>게시판 목록 - 표준프레임워크 심플 홈페이지템플릿</title>
                ...
                <div class="layout">
                    ...
                    <div class="content_wrap">
                        <div id="contents" class="content">
                            ...
                            <p class="txt_1">게시판 마스터 정보 목록입니다.</p>
                            <h2 class="tit_2">게시판 정보</h2>
                            ...
                            <form name="frm" action="<c:url value='/cop/bbs/SelectBBSMasterInfs.do'/>" method="post">
                                ...
                                <div class="condition">
                                    ...
                                    <span class="item f_search">
                                        ...
                                        <button class="btn" type="submit" onclick="fn_egov_select_brdMstr('1'); return false;">조회</button>
                                    </span>

                                    <a href="<c:url value='/cop/bbs/addBBSMaster.do'/>" class="item btn btn_blue_46 w_100" onclick="fn_egov_insert_addBrdMstr(); return false;"><spring:message code="button.create"/></a>
                                </div>
                                <!--// 검색조건 -->
                                <!-- 게시판 -->
