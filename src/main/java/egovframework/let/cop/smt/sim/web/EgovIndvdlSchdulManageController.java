...
public class EgovIndvdlSchdulManageController {
	...
	public String EgovIndvdlSchdulManageDailyList(HttpSession session,
	...
	public String EgovIndvdlSchdulManageWeekList(HttpSession session,
			@RequestParam(value = "menuNo", required = false) String menuNo,
			@ModelAttribute("searchVO") ComDefaultVO searchVO, @RequestParam Map<String, Object> commandMap,
			IndvdlSchdulManageVO indvdlSchdulManageVO, ModelMap model) throws Exception {
	...
	public String EgovIndvdlSchdulManageDetail(@ModelAttribute("searchVO") ComDefaultVO searchVO,
			IndvdlSchdulManageVO indvdlSchdulManageVO, @RequestParam Map<String, Object> commandMap, ModelMap model)
			throws Exception {
	...
	public String IndvdlSchdulManageModify(@ModelAttribute("searchVO") ComDefaultVO searchVO,
			@RequestParam Map<String, Object> commandMap, IndvdlSchdulManageVO indvdlSchdulManageVO,
